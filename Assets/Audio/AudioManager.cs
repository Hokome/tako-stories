...
namespace TakoStories
{
	public class AudioManager : MonoSingleton<AudioManager>
	{
		...
		public static AudioSource PlaySound(SoundClip sound, GameObject follow, PlayOptions options)
		{
		...
		private static AudioSource CreateObject(SoundClip sound, PlayOptions options)
		{
			string type = sound.Type.ToString();
			GameObject go = new GameObject($"{type}: {sound.name}");
