...
namespace TakoStories
{
	public class WallCheck : CollisionCheck
	{
		...
		public BufferedBoolean WallLeftBuffer { get; private set; }
		public BufferedBoolean WallRightBuffer { get; private set; }
		...
		private void Start()
		{
			...
			WallLeftBuffer = new BufferedBoolean(bufferDuration);
			WallRightBuffer = new BufferedBoolean(bufferDuration);
		}
		...
		private void OnDrawGizmos()
		{
			...
			if (WallRightBuffer == null)
				WallRightBuffer = new BufferedBoolean(bufferDuration);
			if (WallLeftBuffer == null)
				WallLeftBuffer = new BufferedBoolean(bufferDuration);
